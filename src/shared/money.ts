...
export function sellerLedger(
  ...
  return {
    ...
    refundedCents: 0,
    // Shipping releases the money; an open refund request holds it again until the seller decides.
    balance: fulfilment === 'shipped' || fulfilment === 'received' ? 'available' : 'pending',
  }
}
